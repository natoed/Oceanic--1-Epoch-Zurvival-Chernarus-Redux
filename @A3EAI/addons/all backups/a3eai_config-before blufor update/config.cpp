...
class CfgA3EAISettings {
	...
	addAI_village = 1;
	unitLevel_village = 1;
	spawnChance_village = 0.05;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_city = 1;
	addAI_city = 1;
	unitLevel_city = 2;
	spawnChance_city = 0.05;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_capitalCity = 1;
	addAI_capitalCity = 1;
	unitLevel_capitalCity = 3;
	spawnChance_capitalCity = 0.05;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_remoteArea = 1;
	addAI_remoteArea = 1;
	unitLevel_remoteArea = 1;
	...
	waypointBlacklistAir[] = {"Stavros"};	//Affects Air vehicles (including UAVs)
	waypointBlacklistLand[] = {"Stavros"};  	//Affects Land vehicles (including UGVs)
	...
	*/
	...
	miscLoot2[] = {"RyanZombiesAntiVirusTemporary_Item","RyanZombiesAntiVirusCure_Item","MortarBucket","MortarBucket","ItemCorrugated","CinderBlocks","jerrycan_epoch","jerrycan_epoch","VehicleRepair","VehicleRepair","CircuitParts"};
