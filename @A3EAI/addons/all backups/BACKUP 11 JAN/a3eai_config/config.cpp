...
class CfgA3EAISettings {
	...
	levelChancesAir[] = {0.5,0.5,0.50,0.40};
	...
	levelChancesLand[] = {0.10,0.10,0.40,0.40};
	...
	airReinforcementSpawnChance3 = 0.50;
