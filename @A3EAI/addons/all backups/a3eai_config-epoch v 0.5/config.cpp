...
class CfgA3EAISettings {
	...
	waypointBlacklistAir[] = {"_MARKER2","_MARKER4","_MARKER6","_MARKER8"};		//Affects Air vehicles (including UAVs)
	waypointBlacklistLand[] = {"_MARKER2","_MARKER4","_MARKER6","_MARKER8"};  	//Affects Land vehicles (including UGVs)
	...
	levelChancesAir[] = {0.00,0.00,0.50,0.50};
	...
	levelChancesLand[] = {0.05,0.15,0.20,0.60};
