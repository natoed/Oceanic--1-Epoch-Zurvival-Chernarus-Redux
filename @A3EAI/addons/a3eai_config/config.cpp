...
class CfgA3EAISettings {
	...
	addAI_village = 1;
	unitLevel_village = 1;
	spawnChance_village = 0.15;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_city = 1;
	addAI_city = 1;
	unitLevel_city = 2;
	spawnChance_city = 0.20;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_capitalCity = 1;
	addAI_capitalCity = 1;
	unitLevel_capitalCity = 3;
	spawnChance_capitalCity = 0.35;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_remoteArea = 1;
	addAI_remoteArea = 1;
	unitLevel_remoteArea = 3;
	spawnChance_remoteArea = 0.05;
	
	//(Static/Dynamic/Random Spawns) minAI: Minimum number of units. addAI: maximum number of additional units. unitLevel: Unit level (0-3)
	minAI_wilderness = 1;
	addAI_wilderness = 1;
	unitLevel_wilderness = 3;
	spawnChance_wilderness = 0.05;
	...
	launcherTypes[] = {"launch_RPG32_F","launch_RPG7_F"}; 
	...
	waypointBlacklistAir[] = {"_MARKER5"};		//Affects Air vehicles (including UAVs)
	waypointBlacklistLand[] = {"_MARKER5"};  	//Affects Land vehicles (including UGVs)
	...
	levelChancesAir[] = {0.20,0.20,0.30,0.30};
	
	//Set minimum and maximum wait time in seconds to respawn an AI vehicle patrol after vehicle is destroyed or disabled. (Default: Min 600, Max 900).
	respawnAirMinTime = 600;
	respawnAirMaxTime = 1200;
	...
	levelChancesLand[] = {0.05,0.15,0.30,0.50};
	...
	landVehicleList[] = {
		...
		{"I_mas_cars_Ural_fuel",1},
		{"I_mas_cars_Ural_repair",1},
		{"I_mas_cars_Ural_ammo",1},
		{"I_mas_cars_LR_soft_Unarmed",1},
		{"B_mas_cars_LR_Unarmed",1},
		{"B_mas_cars_Hilux_Unarmed",1},
	...
	airReinforcementSpawnChance0 = 0.05;
	airReinforcementSpawnChance1 = 0.10;
	airReinforcementSpawnChance2 = 0.15;
	airReinforcementSpawnChance3 = 0.20;
	...
	*/
	...
	skill1[] = {
		...
		{"spotDistance",0.20,0.40},
		{"spotTime",0.10,0.20},
		{"courage",0.20,0.40},
		{"reloadSpeed",0.20,0.40},
	...
	skill2[] = {
		...
		{"spotTime",0.10,0.50},
		{"courage",0.30,0.60},
		{"reloadSpeed",0.30,0.60},
		{"commanding",0.30,0.60},
		{"general",0.30,0.70}
	};
	...
	skill3[] = {
		...
		{"aimingSpeed",0.40,0.70},
		{"spotDistance",0.40,0.70},
		{"spotTime",0.40,0.70},
		{"courage",0.60,0.70},
	...
	addUniformChance0 = 0.99;
	addUniformChance1 = 0.99;
	addUniformChance2 = 0.99;
	addUniformChance3 = 0.99;
	...
	useWeaponChance1[] = {0.20,0.78,0.01,0.01};
	...
	lootPullChance2 = 0.40;
	lootPullChance3 = 0.50;
	...
	*/
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	uniformTypes0[] = {"U_Rangemaster", "U_Competitor", "U_B_survival_uniform", "U_BG_Guerilla1_1", "U_BG_Guerilla2_1", "U_BG_Guerilla2_2", "U_BG_Guerilla2_3", "U_BG_Guerilla3_1", "U_BG_Guerilla3_2","U_BG_Guerrilla_6_1", "U_CamoBlue_uniform", "U_CamoBrn_uniform", "U_CamoRed_uniform", "U_CamoAloha_uniform", "U_CamoBiker_uniform", "U_CamoBubblegum_uniform","rds_uniform_Worker1","rds_uniform_citizen1","rds_uniform_Profiteer1","rds_uniform_Rocker1","rds_uniform_Woodlander1"};
	uniformTypes1[] = {"U_CamoLumberjack_uniform", "U_CamoOutback_uniform", "U_CamoPink_uniform", "U_CamoPinkPolka_uniform", "U_Wetsuit_uniform", "U_Wetsuit_White", "U_Wetsuit_Blue", "U_Wetsuit_Purp","U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_vest", "U_B_CombatUniform_sgg_tshirt", "U_B_CombatUniform_sgg_vest", "U_B_CTRG_Soldier_F","rds_uniform_Worker2","rds_uniform_citizen2","rds_uniform_Profiteer2","rds_uniform_Rocker2","rds_uniform_Woodlander2"};
	uniformTypes2[] = {"U_B_CTRG_Soldier_2_F", "U_B_CTRG_Soldier_3_F", "U_B_CTRG_1", "U_B_CTRG_2", "U_B_CTRG_3", "U_BG_leader","rds_uniform_Worker3","rds_uniform_citizen3","rds_uniform_Profiteer3","rds_uniform_Rocker3","rds_uniform_Woodlander3"};
	uniformTypes3[] = {"U_B_SpecopsUniform_sgg", "U_B_HeliPilotCoveralls", "U_B_PilotCoveralls", "U_B_T_Soldier_AR_F", "U_B_T_Soldier_F", "U_B_T_Soldier_SL_F", "U_B_CTRG_Soldier_urb_1_F","U_B_CTRG_Soldier_urb_2_F", "U_B_CTRG_Soldier_urb_3_F", "U_Camo_uniform", "U_Wetsuit_Camo", "U_B_T_Sniper_F", "U_B_GhillieSuit", "U_B_FullGhillie_lsh", "U_B_FullGhillie_sard","rds_uniform_Worker4", "rds_uniform_citizen4","rds_uniform_Profiteer4","rds_uniform_Rocker4","rds_uniform_Woodlander4"};
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	foodLoot[] = {"RyanZombiesAntiVirusTemporary_Item","RyanZombiesAntiVirusCure_Item","FoodSnooter","FoodWalkNSons","FoodBioMeat","ItemSodaOrangeSherbet","ItemSodaPurple","ItemSodaMocha","ItemSodaBurst","ItemSodaRbull","honey_epoch","emptyjar_epoch","sardines_epoch","meatballs_epoch","scam_epoch","sweetcorn_epoch","WhiskeyNoodle","ItemCoolerE","ItemVitamins","adrenaline_epoch","caffeinepills_epoch","orlistat_epoch","ItemCanteen_Empty","ItemCanteen_Clean","ItemBottlePlastic_Empty","ItemBottlePlastic_Clean","atropine_epoch","ItemWaterPurificationTablets","ItemCereals","gyro_wrap_epoch","Icecream_epoch","redburger_epoch","bluburger_epoch","Krypto_candy_epoch","ItemBakedBeans","ItemRiceBox","ItemPowderMilk","nanite_cream_epoch","nanite_pills_epoch","iodide_pills_epoch","nanite_gun_epoch","morphine_epoch"};
	miscLoot1[] = {"ibr_cocaine","RyanZombiesAntiVirusTemporary_Item","RyanZombiesAntiVirusCure_Item","PaintCanClear","PaintCanBlk","PaintCanBlu","PaintCanBrn","PaintCanGrn","PaintCanOra","PaintCanPur","PaintCanRed","PaintCanTeal","PaintCanYel","ItemDocument","ItemMixOil","emptyjar_epoch","emptyjar_epoch","FoodBioMeat","Towelette","Towelette","Towelette","Towelette","Towelette","HeatPack","HeatPack","HeatPack","ColdPack","ColdPack","VehicleRepair","CircuitParts","ItemCoolerE","ItemScraps","ItemScraps","EngineParts","SpareTire","ItemGlass","ItemDuctTape"};
	miscLoot2[] = {"RyanZombiesAntiVirusTemporary_Item","RyanZombiesAntiVirusCure_Item","MortarBucket","MortarBucket","ItemCorrugated","CinderBlocks","jerrycan_epoch","jerrycan_epoch","VehicleRepair","VehicleRepair","CircuitParts","EngineParts","SpareTire","ItemGlass","ItemDuctTape","KitTentA","KitTentDome","ItemCanvas","ItemSeedBag"};
